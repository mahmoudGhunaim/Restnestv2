...
const PrivacyPolicy = () => {
  return (
    <Layout>
                    <Seo
            title="Privacy Policy | RestNest – Protecting Your Personal Data"
            description="Read RestNest's Privacy Policy updated as of February 28, 2024, outlining our commitment to safeguarding your personal information. Learn about our data collection, use, and disclosure practices to ensure your privacy rights are protected while using our services. Discover how we handle personal data, tracking technologies, and your rights under privacy laws, including the CCPA/CPRA  "
        />
   ...
   <section className='RentalAgreement-sec'>
       <div className='RentalAgreement-container'>
           <div className='RentalAgreement-list'>
               ...
               <Link to='#Interpretation'>Interpretation and Definitions</Link>
               <Link to='#Types-of-Data-Collected'>Collecting and Using Your Personal Data</Link>
               <Link to='#Detailed'>Detailed Information on the Processing of Your Personal Data</Link>
               <Link to='#CCPA/CPRA'>CCPA/CPRA Privacy Notice</Link>
               <Link to='#Children'>Children's Privacy</Link>
               <Link to='#Links'>Links to Other Websites</Link>
               <Link to='#Changes'>Changes to this Privacy Policy</Link>
           ...
           <div className='RentalAgreement-data'>
               ...
               <div className='RentalAgreement-single-data'>
                   <h1 id='#Types-of-Data-Collected'>Types of Data Collected</h1>
                   <div className='gary-line'></div>
...
<p>The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.</p>
               ...
               <div className='RentalAgreement-single-data'>
                   <h1 id='Detailed'>Detailed Information on the Processing of Your Personal Data</h1>
                   <div className='gary-line'></div>
...
<p>When You use Our Service to pay a product and/or service via bank transfer, We may ask You to provide information to facilitate this transaction and to verify Your identity.</p>
               ...
               <div className='RentalAgreement-single-data'>
                   <h1 id='CCPA/CPRA'>CCPA/CPRA Privacy Notice</h1>
                   <div className='gary-line'></div>
...
<ul>
<li>By email: info@restnest.ca</li>
</ul>
...
<p>We collect, use and disclose sensitive personal information in ways that are necessary to provide the Service. For more information on how We use Your personal information, please see the &quot;Use of Your Personal Data&quot; section or contact us.</p>
               ...
               <div className='RentalAgreement-single-data'>
                   <h1 id='Children'>Children's Privacy</h1>
                   <div className='gary-line'></div>
               ...
               <div className='RentalAgreement-single-data'>
                   <h1 id='Links'>Links to Other Websites</h1>
                   <div className='gary-line'></div>
